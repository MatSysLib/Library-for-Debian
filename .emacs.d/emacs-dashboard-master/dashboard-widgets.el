...
(defvar dashboard-banner-logo-title "
    ...
    В эту систему математического моделирования добавлены две библиотеки:       
    библиотка параллельных алгоритмов численного анализа и вывода графики.
    Данную систему можно использовать для программирования,
    решения параллельных задач численного анализа и вывода графиков функций. 
    Инструкцию по работе с установленной системой можно загрузить по ссылке:
                     https://github.com/MatSysLib/Library 
"
...
(defvar dashboard-footer
  (let ((list '("Авторы разработанной системы математического моделирования:
          Лутошкин Денис и Стародумов Вячеслав"
                )))
