...
!DEC$ ATTRIBUTES STDCALL :: gluBeginCurve
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluBeginPolygon
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluBeginSurface
IMPORT
TYPE(C_PTR), VALUE :: nurb
...
!DEC$ ATTRIBUTES STDCALL :: gluBeginTrim
IMPORT
TYPE(C_PTR), VALUE :: nurb
...
!DEC$ ATTRIBUTES STDCALL :: gluBuild1DMipmapLevels
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluBuild1DMipmaps
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluBuild2DMipmapLevels
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluBuild2DMipmaps
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluBuild3DMipmapLevels
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluBuild3DMipmaps
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluCheckExtension
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluCylinder
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluDeleteNurbsRenderer
IMPORT
TYPE(C_PTR), VALUE :: nurb
...
!DEC$ ATTRIBUTES STDCALL :: gluDeleteQuadric
IMPORT
TYPE(C_PTR), VALUE :: quad
...
!DEC$ ATTRIBUTES STDCALL :: gluDeleteTess
IMPORT
TYPE(C_PTR), VALUE :: tess
...
!DEC$ ATTRIBUTES STDCALL :: gluEndCurve
IMPORT
TYPE(C_PTR), VALUE :: nurb
...
!DEC$ ATTRIBUTES STDCALL :: gluEndPolygon
IMPORT
TYPE(C_PTR), VALUE :: tess
...
!DEC$ ATTRIBUTES STDCALL :: gluEndSurface
IMPORT
TYPE(C_PTR), VALUE :: nurb
...
!DEC$ ATTRIBUTES STDCALL :: gluEndTrim
IMPORT
TYPE(C_PTR), VALUE :: nurb
...
!DEC$ ATTRIBUTES STDCALL :: gluErrorString
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluGetString
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluGetNurbsProperty
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluGetTessProperty
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluLoadSamplingMatrices
IMPORT
TYPE(C_PTR), VALUE :: nurb
...
!DEC$ ATTRIBUTES STDCALL :: gluLookAt
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluNewNurbsRenderer
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluNewQuadric
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluNewTess
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluNextContour
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluNurbsCallback
IMPORT
INTEGER(GLenum), VALUE :: which
...
!DEC$ ATTRIBUTES STDCALL :: gluNurbsCallbackData
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluNurbsCallbackDataEXT
IMPORT
TYPE(C_PTR), VALUE :: nurb, userData
...
!DEC$ ATTRIBUTES STDCALL :: gluNurbsCurve
IMPORT
INTEGER(GLenum), VALUE :: type
...
!DEC$ ATTRIBUTES STDCALL :: gluNurbsProperty
IMPORT
INTEGER(GLenum), VALUE :: property
...
!DEC$ ATTRIBUTES STDCALL :: gluNurbsSurface
IMPORT
INTEGER(GLenum), VALUE :: type
...
!DEC$ ATTRIBUTES STDCALL :: gluOrtho2D
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluPartialDisk
IMPORT
INTEGER(GLint), VALUE :: slices, loops
...
!DEC$ ATTRIBUTES STDCALL :: gluPerspective
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluPickMatrix
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluProject
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluPwlCurve
IMPORT
INTEGER(GLenum), VALUE :: type
...
!DEC$ ATTRIBUTES STDCALL :: gluQuadricCallback
IMPORT
INTEGER(GLenum), VALUE :: which
TYPE(C_FUNPTR), VALUE :: CallBackFunc
TYPE(C_PTR), VALUE :: quad
...
!DEC$ ATTRIBUTES STDCALL :: gluQuadricDrawStyle
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluQuadricNormals
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluQuadricOrientation
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluQuadricTexture
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluScaleImage
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluSphere
IMPORT
INTEGER(GLint), VALUE :: slices, stacks
...
!DEC$ ATTRIBUTES STDCALL :: gluTessBeginContour
IMPORT
TYPE(C_PTR), VALUE :: tess
...
!DEC$ ATTRIBUTES STDCALL :: gluTessBeginPolygon
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluTessCallback
IMPORT
INTEGER(GLenum), VALUE :: which
TYPE(C_FUNPTR), VALUE :: CallBackFunc
TYPE(C_PTR), VALUE :: tess
...
!DEC$ ATTRIBUTES STDCALL :: gluTessEndContour
IMPORT
TYPE(C_PTR), VALUE :: tess
...
!DEC$ ATTRIBUTES STDCALL :: gluTessEndPolygon
IMPORT
TYPE(C_PTR), VALUE :: tess
...
!DEC$ ATTRIBUTES STDCALL :: gluTessNormal
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluTessProperty
IMPORT
INTEGER(GLenum), VALUE :: which
...
!DEC$ ATTRIBUTES STDCALL :: gluTessVertex
IMPORT
TYPE(C_PTR), VALUE :: tess, data
...
!DEC$ ATTRIBUTES STDCALL :: gluUnProject
IMPORT
...
!DEC$ ATTRIBUTES STDCALL :: gluUnProject4
IMPORT
